                          ...
                          <div>
                            ...
                            >
                              <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="tipo-porcentagem" className="cursor-pointer text-sm">Porcentagem</Label>
                              </div>
                              <div className="flex items-center space-x-2">
                                <RadioGroupItem value="valor" id="tipo-valor" />
                                <Label htmlFor="tipo-valor" className="cursor-pointer text-sm">Valor (R$)</Label>
                              </div>
                            </RadioGroup>
                          </div>
                        </div>
