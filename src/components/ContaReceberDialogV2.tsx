...
interface ContaReceberDialogV2Props {
  open: boolean;
...
export function ContaReceberDialogV2({ open, onOpenChange, conta, onSuccess }: ContaReceberDialogV2Props) {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="Ex: Venda, Cliente X..." />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
