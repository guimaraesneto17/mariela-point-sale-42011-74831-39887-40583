    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[95vw] max-h-[95vh] p-0 bg-background/98 backdrop-blur-sm border-border">
        <div className="relative w-full h-full flex flex-col">
          ...
          {/* Área da imagem */}
          <div className="flex-1 relative flex items-center justify-center p-8 min-h-[60vh] bg-muted/5">
            <img
            ...
            {images.length > 1 && (
              <>
                <Button
                  variant="secondary"
                  size="icon"
                  className="absolute left-4 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full shadow-xl hover:scale-110 transition-transform"
                ...
                <Button
                  variant="secondary"
                  size="icon"
                  className="absolute right-4 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full shadow-xl hover:scale-110 transition-transform"
                  onClick={handleNext}
                >
